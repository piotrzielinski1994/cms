...
describe('Pages collection', () => {
  // AC-010 / TC-008: the cta block config is registered in the sections field
  // so editors can add a CTA block and typegen emits it into the blockType union.
  it('should register the "cta" block in the sections blocks array', () => {
