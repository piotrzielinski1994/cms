...
export interface Page {
  id: string;
  title: string;
  sections: (Hero1Block | ImageBlocksSection | ImageBlockBlock | ContactUsSection | FAQ | ProductsListBlock)[];
  seo?: {
    title?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProductsListBlock".
 */
export interface ProductsListBlock {
  id?: string | null;
  blockName?: string | null;
  blockType: 'products-list';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface User {
  id: string;
  name?: string | null;
  roles?: ('user' | 'editor' | 'admin' | 'customer')[] | null;
  updatedAt: string;
  createdAt: string;
  email: string;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  sections?:
    ...
    | {
        ...
        faq?: T | FAQSelect<T>;
        'products-list'?: T | ProductsListBlockSelect<T>;
      };
  seo?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProductsListBlock_select".
 */
export interface ProductsListBlockSelect<T extends boolean = true> {
  id?: T;
  blockName?: T;
}
/**
