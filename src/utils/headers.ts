...
const getPreferences = async () => {
  ...
  let theme = cookieStore.get(THEME_STORAGE_KEY)?.value as Theme;
  ...
  console.log(
    '@@@ cookieStore.get(COOKIES_CONSENT_STORAGE_KEY) | ',
    cookieStore.get(COOKIES_CONSENT_STORAGE_KEY),
  );
  const cookiesConsent: CookiesConsentStore['isAllowed'] =
    cookieStore.get(COOKIES_CONSENT_STORAGE_KEY)?.value === 'true';
